...
export function SiteHeaderClient({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div
          className="fixed inset-x-0 top-[65px] z-40 w-full h-[calc(100vh-65px)] bg-background/80 backdrop-blur-xl md:hidden animate-in slide-in-from-top duration-300 ease-out flex flex-col p-6 justify-between border-t border-border"
