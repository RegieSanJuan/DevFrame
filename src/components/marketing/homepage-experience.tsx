...
const workflow = [
  ...
  },
  {
    ...
    description: "Add your intro, links, skills, and featured work in one pass.",
  },
  {
...
export function HomepageExperience() {
  ...
  return (
    <div ref={rootRef} className="container-shell space-y-24 pt-10 md:space-y-28 md:pt-14">
      <section className="relative overflow-hidden rounded-[40px] border border-white/8 bg-background-alt/82 px-6 py-10 md:px-10 md:py-14 lg:px-14">
        ...
        <div className="relative space-y-12">
          <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
            <span data-hero-item className="section-label">
            ...
            >
              {stackPills.map((item) => (
                <span
                  key={item}
                  className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-foreground-soft"
                >
                  {item}
                </span>
              ))}
          ...
          <div className="grid gap-5 lg:grid-cols-[1.08fr_0.92fr]">
            <Card
              data-hero-panel
              className="overflow-hidden border-white/10 bg-[radial-gradient(circle_at_top,rgba(62,207,142,0.08),transparent_48%)]"
            >
                  ...
                  <div className="space-y-4 p-6">
                    <div className="rounded-[26px] border border-white/10 bg-surface-soft p-5">
                      ...
                      <div className="mt-4 grid gap-3 md:grid-cols-2">
                        {["Name", "Role", "Skills", "Featured project"].map((item) => (
                          <div
                            key={item}
